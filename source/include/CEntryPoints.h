...
VIREO_EXPORT EggShellResult EggShell_FindSubValue(TypeManagerRef tm, TypeRef typeRef, void* pData, const char* eltName, TypeRef* typeRefLocation, void** dataRefLocation);
